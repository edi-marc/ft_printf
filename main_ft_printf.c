...
/*   Updated: 2021/03/04 17:36:25 by edi-marc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	origin = printf("[%-x]_[%-X]" , NULL , 0);
	printf("\n");
	ft = ft_printf("[%-x]_[%-X]" , NULL , 0);
	check_printf(ft, origin);
	...
	origin = printf("[%06x]_[%06.x]_[%10x]_[%05.x]" , 42 , 2, 0, 0);
	printf("\n");
	ft = ft_printf("[%06x]_[%06.x]_[%10x]_[%05.x]" , 42 , 2, 0, 0);
	check_printf(ft, origin);
